...
export const MultiSelect = (props) => {
    ...
    return <div style={{ width: "100%", position: 'relative' }}>
        {/* <span ref={lblPlaceholder} style={{ position: 'absolute', top: '50%', transform: 'translateY(-50%)', marginTop: '-3px', left: '8px', color: '#d8bdbd', fontSize: 14, ...placeholderStyle }}>{props.placeholder}</span> */}
