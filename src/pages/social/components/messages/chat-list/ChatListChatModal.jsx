...
const ChatList = forwardRef((props, ref) => {
  ...
  return (
    <div className="chat-list-box" style={{position:'absolute', zIndex:100, boxShadow:'2px 0px 15px rgba(39, 39, 39, 0.1)'}}>
      <div style={{display:'flex', alignItems:'center', justifyContent:'space-between', marginLeft:10, marginRight:10, marginTop:12}}>
        <div style={{fontSize:16, fontWeight:'bold', width:'max-content'}}>Tin nhắn</div>
        <div
                    style={{
                      padding: "6px 10px",
                      cursor: "pointer",
